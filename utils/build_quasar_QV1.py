...
# print(len(sys.argv))
if len(sys.argv) != 3:
    print('Please provid [ devx || prod ] [ project name ] \n\n')
    sys.exit(0)
...
app_dir = home_dir + "projects/QV1/" + app
dist_dir = app_dir + "/dist/spa"
pub_dir = home_sites + env + "/public/QV1/"
app_dist_dir = home_sites + env + "/public/QV1/" + app
view_file = os.path.join(home_sites, env) + '/resources/views/QV1/' + app + '.blade.php'
...
print('\n -- copy the view file: ', index_file, view_file)
