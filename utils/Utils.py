...
def my_argparse():
    parser = argparse.ArgumentParser(
        description='parse file and ,,,')
    parser.add_argument("infile", metavar='str', type=str, nargs='?',
                        default='old_lnks', help='input file, default to /home/swang/bin_X/old_lnks')
...
def print_sec_header_dt(): print('\n Loading DateTime  ', 'Symbol  ', ' Price', '  Change', '52_W_low', '52W_high')
