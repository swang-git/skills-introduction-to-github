...
function getPropertyKey () { // used by reflection functions get/set and others
  ...
  else if (props.label === 'Glucose') return 'glucose'
  else if (props.label === 'Blood Glucose Level') return 'glucose'
  else if (props.label === 'Sugar Level') return 'glucose'
  ...
  else if (props.label === 'Volume') return 'vol'
  return props.label
}
function reset () {
