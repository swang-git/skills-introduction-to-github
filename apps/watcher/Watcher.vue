<template>
<div class="q-pa-xs" :class="{ fixed: clickedIdx < 1}" style="width:795px">
  <div v-for="(e, i) in palist" :key=e.id>
    <div :style="getLineBackground(i)" :class="{ 'bg-purple-10':!e.hideIt }">
      <div class="row cursor-pointer" style="font-size:20px;font-weight:400;margin:0 0 0 2px">
        ...
        <div class="q-pl-md text-right" style="width:160px" @click="showDar(e, 'add')">{{ formatCurrency(e.portfolio) }}</div>
