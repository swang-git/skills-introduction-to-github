...
for page in range(1, MAX_PAGES):
    ...
    # url = 'http://bbs1.people.com.cn/board/' + CAT_INDEX + '/' + str(page) + '.html'   # http://bbs1.people.com.cn/board/1/2/1.html
    if TESTING: url = test_site
    print('processing page', url)
    # page = request.urlopen(url)
    # page = requests.get(url)
    # req = Request(url, headers={'User-Agent': 'Mozilla/5.0'})  ## this get IncompleteRead Exception
