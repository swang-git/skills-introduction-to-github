...
USE princeton_golf;
CREATE DEFINER=`pccadmin`@`%` PROCEDURE get_club_index(tid INT, year_begin BOOLEAN)
BEGIN
...
CALL get_club_index(68, 0); -- regular club index
-- SELECT * from tmp_club_index;

CALL get_club_index(68, 1); -- year begin club index
-- SELECT * from tmp_club_index_yb;
