...
SELECT p.id as pid, tp.id, concat(p.lastname, ', ', p.firstname) as fullname, p.gender, CASE WHEN hole19 = 'Don' or hole19='Yes' THEN 'Yes' ELSE 'No' END as dinner, 
        ...
        -- 1.1 as npy,
        -- (ybcx.club_index - cx.club_index) as npy,
        py.poy, null as captain
